                    ...
                    <div class="col-sm-5 sidenav">
                        <form action="/updateSpecification/{{ $specification->id }}" method="post" style="border: 1px whitesmoke solid; margin-top: 10%; padding: 3%; background-color: white;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control"  name="qty" placeholder="{{ $specification->qty }}">

                            </div>

                            <div class="form-group">
                                <label>Etichetta (Nuovo - Usato)</label>
                                <input type="text" class="form-control"  name="description" placeholder="{{ $specification->description }}">
                            </div>
