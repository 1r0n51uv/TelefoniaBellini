<div class="row justify-content-center">
    <div class="col-md-4 col-xs-12" style="margin-top: 3%">
        ...
        <figure class="snip1104 apple" style="margin: 0 auto">
            <div>
                <img class="img-responsive" src="https://firebasestorage.googleapis.com/v0/b/telbel.appspot.com/o/home%2FappleHome.png?alt=media&token=6a951136-def4-4dad-8819-f4c18ed9f5cd" alt="sample33" />
            </div>
